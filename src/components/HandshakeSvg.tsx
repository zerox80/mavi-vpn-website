    ...
    return (
        ...
        >
            ...
            <g transform="translate(100, 50)">
                <rect width="140" height="60" rx="8" fill="url(#clientGrad)" stroke="var(--border)" strokeWidth="2" filter="url(#subtleGlow)" />
                <text x="70" y="32" textAnchor="middle" fill="var(--text-primary)" fontSize="16" fontWeight="700">Client</text>
                {/* Timeline Line */}
                <line x1="70" y1="60" x2="70" y2="350" stroke="var(--border)" strokeWidth="2" strokeDasharray="6 4" />
            </g>

            {/* Server Node */}
            <g transform="translate(560, 50)">
                <rect width="140" height="60" rx="8" fill="url(#serverGrad)" stroke="var(--accent)" strokeWidth="2" filter="url(#glow)" />
            ...
            <g transform="translate(170, 140)">
                <line x1="0" y1="0" x2="450" y2="20" stroke="var(--accent)" strokeWidth="2" markerEnd="url(#arrowAccent)" />
                <rect x="120" y="-20" width="220" height="26" rx="4" fill="var(--bg-primary)" stroke="var(--border)" />
            ...
            <g transform="translate(170, 200)">
                ...
                <rect x="150" y="-20" width="160" height="26" rx="4" fill="var(--bg-primary)" stroke="var(--border)" />
            ...
            <path d="M 630 230 Q 720 230 720 260 Q 720 290 630 290" fill="none" stroke="var(--border)" strokeWidth="2" strokeDasharray="4 2" markerEnd="url(#arrow)" />
            ...
            <g transform="translate(170, 310)">
                <line x1="450" y1="0" x2="0" y2="20" stroke="var(--accent)" strokeWidth="2" markerEnd="url(#arrowAccent)" />
                <rect x="80" y="-15" width="280" height="26" rx="4" fill="var(--bg-primary)" stroke="var(--accent)" filter="url(#subtleGlow)" />
