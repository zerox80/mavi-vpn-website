        ...
        <header className={`navbar ${scrolled ? 'navbar-scrolled' : ''}`}>
            <div className="container navbar-container">
                ...
                <div className="nav-actions">
                    <a href="https://github.com/zerox80/mavi-vpn" target="_blank" rel="noopener noreferrer" className="btn-primary btn-sm nav-cta-desktop">GitHub Repo</a>
                ...
                {mobileOpen && (
                    ...
                    >
                        ...
                        <div className="mobile-menu-actions">
                            <a href="https://github.com/zerox80/mavi-vpn" target="_blank" rel="noopener noreferrer" className="btn-primary" onClick={closeMobile}>GitHub Repo</a>
                        </div>
                    </motion.div>
                )}
            </AnimatePresence>
