        ...
        <div className="hero-terminal">
            ...
            <div className="terminal-body">
                ...
                <div className="terminal-line">
                    ...
                    <span>&nbsp;offload active &middot; BBR congestion control</span>
                </div>
                <div className="terminal-line">
                    <span className="terminal-warn">&nbsp;&rarr;</span>
                    <span>&nbsp;Client connected:</span>
                    <span className="terminal-success">&nbsp;10.8.0.2</span>
                    <span>&nbsp;(CR Level 2 + ECH)</span>
                </div>
                <div className="terminal-line">
                    <span className="terminal-success">&nbsp;&bull;</span>
                    <span>&nbsp;Throughput:</span>
                    <span className="terminal-accent">&nbsp;891 Mbit/s</span>
                    <span>&nbsp;&middot; 0 fragments &middot; 0 drops</span>
